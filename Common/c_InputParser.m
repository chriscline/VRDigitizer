	...
	methods
		...
		function parse(o,varargin)
			...
			for i=1:o.numParameters
				...
				elseif o.parameters(i).isOptional
					p.addOptional(o.parameters(i).name,o.parameters(i).default,o.parameters(i).validator);
				else
					p.addParameter(o.parameters(i).name,o.parameters(i).default,o.parameters(i).validator);
				end
			end
			p.parse(varargin{:});
